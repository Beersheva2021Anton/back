...
public interface VisitRepository extends JpaRepository<Visit, Integer> {
	...
	@Query(value = "select v.patient.id as patientId, v.patient.name as patientName, " +
			"v.doctor.name as doctorName, v.date as visitDate from Visit v " +	
			"where v.patient.id=:patientId and v.date between :from and :to")
